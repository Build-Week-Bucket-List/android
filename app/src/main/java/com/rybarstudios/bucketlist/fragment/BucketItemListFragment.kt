...
import com.rybarstudios.bucketlist.adapter.BucketItemRecyclerViewAdapter
...
class BucketItemListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_bucket_item_list, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val movieListAdapter = BucketItemRecyclerViewAdapter(
