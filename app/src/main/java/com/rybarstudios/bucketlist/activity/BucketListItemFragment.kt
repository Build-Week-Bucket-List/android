 ...
 * [BucketListItemFragment.OnListFragmentInteractionListener] interface.
 */
class BucketListItemFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_bucketlistitem_list, container, false)
